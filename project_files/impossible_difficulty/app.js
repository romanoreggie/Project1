...
function updateGameArea() {
  ...
  if (everyinterval(320)) {
    myObstacles.push(new component(70, 70, "https://i.imgur.com/k1gfSzQ.png", 60, 0, "image"));
  }
  for (i = 0; i < myObstacles.length; i += 1) {
    myObstacles[i].y += 2;
  ...
  if (everyinterval(750)) {
    y = myGameArea.canvas.height;
    myObstacles3.push(new component(70, 70, "https://i.imgur.com/k1gfSzQ.png", 750, 0, "image"));
  }
  for (i = 0; i < myObstacles3.length; i += 1) {
    myObstacles3[i].y += 2;
